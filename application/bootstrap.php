...
{
    Kohana_Exception::$error_view = 'errors/default';
}
...
Cookie::$salt = 'youngistanmerijaan';
...
Route::set('mart','(<controller>(/<action>(/<id>)))')
    ->defaults(array(
...
Route::set('talk','(<controller>(/<action>(/<id>)))')
    ->defaults(array(
...
Route::set('settings','(<controller>(/<action>(/<id>)))')
    ->defaults(array(

        'controller' => 'settings',
        'action' => 'index'
    ));
Route::set('ticket', 'ticket')
    ->defaults(array(

        'controller' => 'user',
        'action' => 'ticket'
    ));
Route::set('worldcup', 'worldcup')
    ->defaults(array(
